    ...
    <div className="flex overflow-hidden items-center justify-center min-h-screen text-center">
      <div className="relative flex flex-col m-6 space-y-8 bg-opacity-40 bg-pink-600 shadow-2xl rounded-2xl md:flex-row md:space-y-0">
        <form
          ...
          className="flex flex-col justify-center p-6 md:p-6"
        >
          <span className="mb-1 text-4xl font-bold">
            🚩Bienvenido de nuevo.{" "}
          </span>
          <span className="font-light text-yellow-300 mb-3">
            <label className="text-white">¡Nos alegra tenerte de vuelta!</label>{" "}
            Por favor, ingrese sus credenciales. 😋
          </span>
          <div className="py-4">
            <span id="email" className="mb-2 text-md">
              Correo electrónico
            </span>
            <input
              required
              ...
              className="focus mt-2 w-full p-2 bg-gray-700 border border-yellow-300 rounded-md placeholder:font-light placeholder:text-gray-400 focus:border-none selection:bg-purple-400 selection:text-black"
            />
          </div>
          <div className="py-1">
            ...
            <input
              ...
              name="password"
              placeholder="********"
              className="mt-2 w-full p-2 bg-gray-700 border border-yellow-300 rounded-md placeholder:font-light placeholder:text-gray-400 focus:border-none selection:bg-purple-400 selection:text-black"
            />
          </div>
          ...
          <div className="text-center text-gray-400">
            ...
            <span className="font-bold text-black">
              <Link
                href="/register"
                className="text-white text-md hover:opacity-50 transition duration-200"
              >
                {" "}
                Registrate aquí
              </Link>
        ...
        <div className="relative">
          ...
          <div className="absolute hidden bottom-10 right4 p-6 bg-black bg-opacity-30 backdrop-blur-sm rounded drop-shadow-lg md:block">
            <span className="text-white text-xl">
              Descubre la claridad mental con MindTracer: Tu primer paso hacia
