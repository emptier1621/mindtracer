import { Card, CardHeader, Divider, CardBody, CardFooter, Progress, Button, Image, Link } from '@nextui-org/react'
import React from 'react'

function DashboardTestCard(props:{titulo:string,siglas:string,resumen:string, percent:number, link:string}) {
  return (
              ...
              <Card className="max-w-[400px] hover:scale-105 cursor-default">
                <CardHeader className="flex">
                  ...
                  <div className="flex flex-col w-full items-center justify-center">
                    ...
                    <p className="text-small text-center text-foreground">{props.siglas}</p>
                  </div>
                </CardHeader>
                <Divider />
